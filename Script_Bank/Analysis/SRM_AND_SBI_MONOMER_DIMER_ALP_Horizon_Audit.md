...
Authoritative companion for `Script_Bank/Analysis/SRM_AND_SBI_MONOMER_DIMER_ALP_Horizon_Audit.py` and its
engine `srm_and_sbi_monomer_dimer_alp/horizon_audit_runner.py` (statistics kernel:
`srm_and_sbi_monomer_dimer_alp/horizon_audit.py`). This note explains what the audit tests, how to run its
...
MACHINE_PROFILE=<p> python Script_Bank/Analysis/SRM_AND_SBI_MONOMER_DIMER_ALP_Horizon_Audit.py \

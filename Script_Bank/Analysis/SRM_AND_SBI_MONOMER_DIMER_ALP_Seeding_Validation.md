...
Companion to `SRM_AND_SBI_MONOMER_DIMER_ALP_Seeding_Validation.py`. The script asserts that
...
`Script_Bank/HPC/SRM_AND_SBI_MONOMER_DIMER_ALP_HPC_Simulation.sh`; the CORE = TRAIN + TEST

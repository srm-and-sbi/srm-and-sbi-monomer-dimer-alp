...
`SRM_AND_SBI_MONOMER_DIMER_ALP_Experiment_CD86_CTLA-4_Controls_Temporal_Dynamics.md`, which
...
Written to
`<data_bank>/<posit_subdir>/SRM_AND_SBI_MONOMER_DIMER_ALP_<timing_label>_MAP_Experiment_CD86_CTLA-4_CONTROLS/`

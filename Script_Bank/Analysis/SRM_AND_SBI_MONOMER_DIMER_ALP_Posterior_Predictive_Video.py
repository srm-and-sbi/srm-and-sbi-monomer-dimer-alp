...
ROLE. Take the eleven reaction-diffusion parameters INFERRED from one real MET recording, simulate a
...
from srm_and_sbi_monomer_dimer_alp.posterior_predictive_video_runner import (

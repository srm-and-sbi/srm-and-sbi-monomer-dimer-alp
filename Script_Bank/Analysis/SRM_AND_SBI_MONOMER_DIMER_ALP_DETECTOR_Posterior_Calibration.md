...
Companion to `SRM_AND_SBI_MONOMER_DIMER_ALP_DETECTOR_Posterior_Calibration.py`, the detector shim
...
→ **`SRM_AND_SBI_MONOMER_DIMER_ALP_Posterior_Calibration.md`**
...
`<project_alias>` is `SRM_AND_SBI_MONOMER_DIMER_ALP_DETECTOR` for this workflow.

...
The analysis runs on one shared engine, `srm_and_sbi_monomer_dimer_alp.sample_geometric_median_runner`,
over the workflow-agnostic kernel `srm_and_sbi_monomer_dimer_alp.sample_geometric_median`. The kernel knows

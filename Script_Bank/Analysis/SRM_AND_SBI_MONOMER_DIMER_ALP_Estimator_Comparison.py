...
detector twin (``SRM_AND_SBI_MONOMER_DIMER_ALP_DETECTOR_Estimator_Comparison.py``) is identical except
...
Usage:
    MACHINE_PROFILE=<profile> python SRM_AND_SBI_MONOMER_DIMER_ALP_Estimator_Comparison.py \\

...
Companion to `SRM_AND_SBI_MONOMER_DIMER_ALP_Estimator_Comparison.py` (biology) and
`SRM_AND_SBI_MONOMER_DIMER_ALP_DETECTOR_Estimator_Comparison.py` (detector). This is the
...
```bash
python SRM_AND_SBI_MONOMER_DIMER_ALP_Estimator_Comparison.py \
...
python SRM_AND_SBI_MONOMER_DIMER_ALP_DETECTOR_Estimator_Comparison.py \

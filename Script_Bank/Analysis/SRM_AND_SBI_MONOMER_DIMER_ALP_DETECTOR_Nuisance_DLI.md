...
Companion to `SRM_AND_SBI_MONOMER_DIMER_ALP_DETECTOR_Nuisance_DLI.py`. The Detector calibrates the imaging
...
Detector-namespaced project alias `SRM_AND_SBI_MONOMER_DIMER_ALP_DETECTOR`):

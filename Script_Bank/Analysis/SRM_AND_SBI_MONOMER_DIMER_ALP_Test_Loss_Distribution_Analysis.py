...
detector twin (``SRM_AND_SBI_MONOMER_DIMER_ALP_DETECTOR_Test_Loss_Distribution_Analysis.py``) is
...
Usage:
    MACHINE_PROFILE=<profile> python SRM_AND_SBI_MONOMER_DIMER_ALP_Test_Loss_Distribution_Analysis.py \\

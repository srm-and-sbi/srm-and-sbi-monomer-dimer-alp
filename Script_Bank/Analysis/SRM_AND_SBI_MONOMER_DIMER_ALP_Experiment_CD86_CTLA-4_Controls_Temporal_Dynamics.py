...
`SRM_AND_SBI_MONOMER_DIMER_ALP_Experiment_CD86_CTLA-4_Controls_Temporal_Dynamics.md` next to
this script for the full scientific interpretation.

Usage:
    MACHINE_PROFILE=<profile> python \\
        SRM_AND_SBI_MONOMER_DIMER_ALP_Experiment_CD86_CTLA-4_Controls_Temporal_Dynamics.py --total-time-seconds 2.0

    # preview the resolved paths without reading or plotting anything:
    MACHINE_PROFILE=<profile> python \\
        SRM_AND_SBI_MONOMER_DIMER_ALP_Experiment_CD86_CTLA-4_Controls_Temporal_Dynamics.py --total-time-seconds 2.0 --dry-run
"""
...
# SRM_AND_SBI_MONOMER_DIMER_ALP_Experiment_CD86_CTLA-4_Controls.py) so this analysis reads the
...
def _write_report(fig_dir, meta, results):
    ...
    L.append(f"Generated by "
             f"`SRM_AND_SBI_MONOMER_DIMER_ALP_Experiment_CD86_CTLA-4_Controls_Temporal_Dynamics.py` "

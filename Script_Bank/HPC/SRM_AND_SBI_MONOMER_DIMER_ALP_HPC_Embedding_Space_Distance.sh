...
# SRM_AND_SBI_MONOMER_DIMER_ALP_HPC_Submit.sh, and is submitted directly with sbatch.
#
...
case "$WORKFLOW" in
    biology)  SCRIPT="$REPO/Script_Bank/Analysis/SRM_AND_SBI_MONOMER_DIMER_ALP_Embedding_Space_Distance.py" ;;
    detector) SCRIPT="$REPO/Script_Bank/Analysis/SRM_AND_SBI_MONOMER_DIMER_ALP_DETECTOR_Embedding_Space_Distance.py" ;;

...
# (SRM_AND_SBI_MONOMER_DIMER_ALP_HPC_Generate_Controller.sh): DRYRUN=1 prints, DRYRUN=0
...
#     bash SRM_AND_SBI_MONOMER_DIMER_ALP_HPC_Submit.sh <stage> [KEY=VALUE ...]
#
...
case "$STAGE" in
  simulation)
    SUBMIT_SCRIPT="$REPO/Script_Bank/HPC/SRM_AND_SBI_MONOMER_DIMER_ALP_HPC_Simulation.sh"
    ...
    JOBNAME="SRM_AND_SBI_MONOMER_DIMER_ALP_${timing_label}_Simulation_${split_uc}"
  ...
  inference)
    ...
    JOBNAME="SRM_AND_SBI_MONOMER_DIMER_ALP_${timing_label}_Inference"
  ...
  evaluation)
    ...
    JOBNAME="SRM_AND_SBI_MONOMER_DIMER_ALP_${timing_label}_Evaluation"
  ...
  experiment)
    ...
    JOBNAME="SRM_AND_SBI_MONOMER_DIMER_ALP_${timing_label}_Experiment"

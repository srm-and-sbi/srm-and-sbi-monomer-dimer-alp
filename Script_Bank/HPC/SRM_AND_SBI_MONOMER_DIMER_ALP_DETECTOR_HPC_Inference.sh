...
# SRM_AND_SBI_MONOMER_DIMER_ALP_DETECTOR_<timing_label>_Inference; with no TOTAL_TIME set the
...
INFER_PY="$REPO/Script_Bank/Prime/SRM_AND_SBI_MONOMER_DIMER_ALP_DETECTOR_Inference.py"

...
# SRM_AND_SBI_MONOMER_DIMER_ALP_<timing_label>_Experiment; with no TOTAL_TIME set the
...
EXP_PY="$REPO/Script_Bank/Prime/SRM_AND_SBI_MONOMER_DIMER_ALP_Experiment.py"

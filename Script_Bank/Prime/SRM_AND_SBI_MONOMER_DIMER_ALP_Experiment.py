...
workflows: ``srm_and_sbi_monomer_dimer_alp.experiment_runner.run_experiment`` (which routes cell
discovery / windowing / sharding through the shared ``experiment_support`` module). This entry
point is the biology shim; the detector twin (``SRM_AND_SBI_MONOMER_DIMER_ALP_DETECTOR_Experiment.py``)

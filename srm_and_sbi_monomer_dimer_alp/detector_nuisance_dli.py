...
detector calibration is never drawn or built anywhere: the detector re-images the condition's
RDS trajectory tier, whose eleven-parameter `Theta_Set` (the biology's own labels) is the

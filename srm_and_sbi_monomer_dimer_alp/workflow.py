...
def biology_workflow() -> WorkflowConfig:
    ...
    from srm_and_sbi_monomer_dimer_alp import parameterization as biology_param
...
def detector_workflow() -> WorkflowConfig:
    ...
    from srm_and_sbi_monomer_dimer_alp import parameterization as biology_param
    from srm_and_sbi_monomer_dimer_alp import detector_parameterization as detector_param
